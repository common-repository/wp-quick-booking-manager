...
<div class="wrapper">
  <div class="wrap" style="float:left; width:90%;">
        ...
        <div class="metabox-holder" style="width:98%; float:left;">
            <div id="namediv" class="stuffbox" style="width:60%;min-height:450px;">
              ...
              <div style="padding-top:15px;margin-left:20px;">
                <a class="btnprover" target="_blank" href="https://codecanyon.net/item/wp-quick-booking-manager-pro/9775460" style="width:100px;height: 20px;background-color: green;color:white;" >WP Quick Booking Manager Pro</a>
              </div>  
               <form id="frmCssFix" action="" method="post" style="width:100%">
                 <div style="margin: 20px;">
                    <ol>
                      <li>Free Installation Service</li>
                      <li>Unlimited Room and Room categories(Type)</li>
                      <li>Integrated Payment Gateways.</li>
                      <li>Built in Shopping Cart Enabled</li>
                      <li>Custom made dynamic Monthly Calendar</li>
                      <li>Full calendar order view at admin Panel</li>
                      <li>Add booking From Admin</li>                      
